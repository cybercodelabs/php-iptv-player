...
use App\Features\Player\Presentation\LiveStreamController;
use App\Features\Player\Presentation\SeriesStreamController;
use App\Features\Player\Presentation\VodStreamController;
...
$router->get('/stream/vod', new VodStreamController());
$router->get('/stream/series', new SeriesStreamController());
$router->get('/stream/live', new LiveStreamController());
